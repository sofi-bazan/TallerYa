...
import 'p_resultados_busqueda.dart';
...
class _PantallaInicioState extends State<PantallaInicio> {
  ...
  void initState() {
    ...
    // NUEVO: Apenas se carga la pantalla, pedimos los datos a Firebase
    // El Future.microtask es un truquito de Flutter para poder usar el viewModel seguro en el inicio
    Future.microtask(() => widget.viewModel.buscarProductos());
  }
